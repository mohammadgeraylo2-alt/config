...
def _ask_gemini_chat_blocking(chat_id, user_message: str) -> str:
    """یه پیام از کاربر رو با تاریخچه‌ی مکالمه‌ش به مدل متنی gemini-2.5-flash
    می‌ده و جواب رو برمی‌گردونه. تاریخچه (حداکثر ۲۰ پیام آخر) توی
    user_chat_history نگه داشته میشه تا مکالمه ادامه‌دار باشه."""
    if not GEMINI_KEY:
