...
async def _watch_rubino_login(chat_id, result_queue):
    ...
    if status == "ok":
        try:
            ...
            await _rx(bot.send_message(chat_id, f"✅ لاگین موفق شد (فایل: {session_path}). این مقدار رو توی Railway به‌عنوان RUBINO_SESSION_B64 ذخیره کن، بعد این پیام رو از چت پاک کن:"))
