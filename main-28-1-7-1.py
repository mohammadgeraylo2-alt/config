...
NSFW_CHECK_PROMPT = (
    "به این تصویر با دقت نگاه کن. اگه محتوای برهنگی، پورنوگرافی، یا خیلی "
    "جنسی/اروتیک داره، فقط بنویس: NSFW\n"
    "در غیر این صورت (حتی اگه لباس اسپرت/شنا/کمی باز باشه ولی پورنوگرافیک "
    "نباشه)، فقط بنویس: SAFE\n"
